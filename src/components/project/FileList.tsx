...
import { useMoeflowCompanionAiTranslate } from './FileListAiTranslate';
...
export const FileList: FC<FileListProps> = ({
  ...
  const [aiTranslateAvailable, startAiTranslate, modalContextHolder] =
    useMoeflowCompanionAiTranslate();
      ...
      <div className="FileList__Header">
        ...
        {aiTranslateAvailable && (
          <Button
            ...
            icon="robot"
            onClick={() => startAiTranslate(items)}
          >
